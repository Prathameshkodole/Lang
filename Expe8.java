...
// User-defined exception for division by zero (optional, as ArithmeticException already exists, but for demonstration)
...
public class Expe8 {
    ...
    public static double divide(int a, int b) throws DivisionByZeroException {
        if (b == 0) {
            throw new DivisionByZeroException("Cannot divide by zero."); //Use user defined exception
        }
        return (double) a / b;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                System.err.println("Error during division: " + e.getMessage()); // Handle user defined Exception
            }

        } catch (InputMismatchException e) {
            System.err.println("Error: Invalid input. Please enter integers only.");
        } catch (NegativeNumberException e) {
            System.err.println("Error: " + e.getMessage()); // Handle user defined Exception
        } finally {
            scanner.close();
